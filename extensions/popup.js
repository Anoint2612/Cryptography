document.addEventListener('DOMContentLoaded', function() {
  ...
  function initializeEventListeners() {
    ...
    // XSS Detection Card click handler
        ...
        if (response.ok) {
            const xssResultHtml = 
                `<div class="space-y-3">
                    ...
                    <p class="text-xs text-gray-600">
                        ${data.is_xss 
                            ? 'Warning: This URL contains potential XSS attack patterns such as script tags or JavaScript event handlers.'
